...
class EntitlementCode(models.TextChoices):
    ...
    PREMIUM_LEARNING = "premium_learning", "Premium learning"
    ...
    PRIVATE_JOURNAL_UNLIMITED = "private_journal_unlimited", "Private journal unlimited"
    PROFESSIONAL_REVIEW_PRIORITY = "professional_review_priority", "Professional review priority"
    GLOBAL_INVESTING_PACK_ACCESS = "global_investing_pack_access", "Global investing pack access"
    TREASURY_BILLS_PACK_ACCESS = "treasury_bills_pack_access", "Treasury bills pack access"
    SACCO_CHAMA_PACK_ACCESS = "sacco_chama_pack_access", "SACCO/chama pack access"
    LAND_PACK_ACCESS = "land_pack_access", "Land pack access"
    DIASPORA_PACK_ACCESS = "diaspora_pack_access", "Diaspora pack access"
    PROFESSIONAL_LEAD_INBOX = "professional_lead_inbox", "Professional lead inbox"
    PROFESSIONAL_PROFILE_PUBLIC = "professional_profile_public", "Professional profile public"
    PROFESSIONAL_CLIENT_NOTES = "professional_client_notes", "Professional client notes"
    PROFESSIONAL_REQUEST_PRIORITY = "professional_request_priority", "Legacy professional request priority"
    PROFESSIONAL_DASHBOARD = "professional_dashboard", "Legacy professional dashboard"
    PROFESSIONAL_LEADS = "professional_leads", "Legacy professional leads"
    PROFESSIONAL_ANALYTICS = "professional_analytics", "Legacy professional analytics"
